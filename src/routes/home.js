    ...
    return (
      <div>
        <div className="grid home">
          ...
          <Box color="#001122">
            <div>
              <p>A passionate group of artists, technologists & friends, interested in improving the world around us and connecting with other amazing humans along the way.</p>
